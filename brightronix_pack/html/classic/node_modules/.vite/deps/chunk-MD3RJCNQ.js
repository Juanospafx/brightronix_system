    ...
    each(data, (dataObject, index) => {
      ...
      if (!dataItem) {
        ...
        keys(properties).forEach((key) => {
          ...
          dataItem.set(key, properties[key]);
          dataItem.set(key + "Working", properties[key]);
        });
      }
      ii = index;
    });
...
//# sourceMappingURL=chunk-MD3RJCNQ.js.map
