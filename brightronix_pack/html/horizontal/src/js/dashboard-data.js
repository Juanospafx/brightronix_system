...
$(function () {
  ...
  /*Apex Column Chart*/
  // Only run if the element exists to prevent errors
  if (document.querySelector("#column_chart_2")) {
    window.Apex = {
      chart: {
        foreColor: "#646A71",
        fontFamily: 'DM Sans',
  ...
  /*Multiple Chart*/
  if (document.querySelector("#radial_chart_2")) {
    var options2 = {
      series: [80, 75],
      stroke: {
        lineCap: 'round'
  ...
  /*Animated Map*/
  if (document.getElementById("anim_map_2")) {
